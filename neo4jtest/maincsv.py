...
GRAPHRAG_FOLDER="./csvtest/output/20240910-144132/artifacts"
...
def main():
    ...
    # # import documents
    # doc_df = pd.read_parquet(f'{GRAPHRAG_FOLDER}/create_final_documents.parquet', columns=["id", "source", "timestamp"])    
    # import_doc(doc_df)
